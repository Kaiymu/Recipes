        ...
        success: function (recipe) {
            ...
            for (let i in sections) {
                ...
                if (!foundTitle) {
                    ...
                    let elems = $(section);
                    let pageTitle = elems[0].innerHTML + ' | Livre de recettes';
            ...
            if (shortenURLs) {
                $('#basedon a, #ingredients a').each(function () {
                    let url = $(this).text();
                    url = getDomain(url);
                    $(this).text(url);
                });
            ...
            $('#ingredients li').each(function () {
                let childrenElement = $(this).children();
                if(childrenElement[0] && childrenElement[0].href) {
                    return;
                }
